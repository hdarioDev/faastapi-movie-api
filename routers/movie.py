...
@movie_router.get('/movies', response_model=List[Movie], tags=['Movies'])
...
@movie_router.get('/movies/{id}', response_model=Movie, tags=['Movies'])
...
@movie_router.post('/movies', response_model=Movie, status_code=status.HTTP_201_CREATED, tags=['Movies'])
...
@movie_router.put('/movies/{id}', response_model=Movie, tags=['Movies'])
...
@movie_router.delete('/movies/{id}', response_model=Movie, tags=['Movies'])
